...
public class DeleteCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Please select customer from following to delete");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (row == -1) {
            JOptionPane.showMessageDialog(null, "Please first select any customer to delete");
        }else{
            String username = (String) table.getValueAt(row, 1);
            CustomerDatabase.deleteCustomerByUsername(username);
