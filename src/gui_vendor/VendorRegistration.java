...
public class VendorRegistration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setFont(new java.awt.Font("ITF Devanagari Marathi", 1, 16)); // NOI18N
        jLabel6.setText("Please fill following to register Vendor");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (userID.getText().isEmpty() || userName.getText().isEmpty() || password.getText().isEmpty()) {
            ...
            Vendor vendor = new Vendor(new Menu(new ArrayList<MenuItem>()), userID.getText(), userName.getText(), password.getText(), UserType.VENDOR);
            VendorDatabase.createOrUpdateVendor(vendor);
               this.dispose();
            new AdminDashboard().setVisible(true);
            JOptionPane.showMessageDialog(null, "Successfully added Vendor");
        }
