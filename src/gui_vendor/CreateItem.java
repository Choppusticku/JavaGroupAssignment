...
public class CreateItem extends javax.swing.JFrame {
    ...
    public CreateItem() {
        ...
        for (MenuItem itm : vendor.getMenu().getItems()) {
            System.out.println(itm.getItemName());
        }
    }
    public CreateItem(Vendor vendor) {
        initComponents();
        this.vendor = vendor;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (name.getText().isEmpty() || price.getText().isEmpty()) {
            ...
            MenuItem menuItem = new MenuItem(name.getText(), Double.parseDouble(price.getText()));
            vendor.addToMenu(menuItem);
            System.out.println(vendor.getMenu().getItems().size());
